...
class server_conn(object):
    ...
    def handle(self,parameters):
        ...
        if self.convert_config_data(data): #valid configuration data
            ...
            params['config_md5'] = md5.md5(json.dumps(self.monitor_dic)).hexdigest() #给配置信息生成md5值
...
class  monitor(object):
    ...
    def run_plugin(self,service_name,monitor_item,lock_obj):
        ...
        self.post_data(service_status)
        print '------going to run:: %s-----' % service_name,monitor_item
    ...
    def run_forever(self):
        ...
        while not stop_event:
            ...
            for service_name,items in self.monitor_list.items(): #循环监控列表 
            ...
            time.sleep(3)
            update_counter +=1
            if update_counter > 5: #update config data each 300secs
    ...
    def update_moniotr_list(self):
        ...
        if cli_sock.convert_config_data(request_data):
            ...
            if params['config_md5'] != new_config_md5:
                ...
                params['config_md5'] = new_config_md5 #存上新的配置信息
                return True
        else:
            return False
    
    def post_data(self,data_dic):
